...
[[scripts/benchmark-search-access.mjs]] compares copy-based sessions from Git with locked sessions using generated indexes, fixed 384-dimensional embeddings, real retrieval, and identical-result checks. [[benchmarks/README.md]] describes methodology and measured tradeoffs; [[benchmarks/search-access-macos.json]] contains the retained results.
